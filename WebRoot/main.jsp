...
<TABLE cellSpacing=0 cellPadding=0 width=749 border=0>
      ...
      <TABLE cellSpacing=0 cellPadding=0 width=173 border=0>
        ...
        <TR>
          ...
          <TD width=165 height="29" bgColor=#7691c7>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<A 
            class=nav 
            href="#" onclick="changeIframe('newOperator.jsp')">新增操作员</A></TD>
        </TR>
        <TR>
        ...
        <TR>
          ...
          <TD width=165 height="29" bgColor=#7691c7>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<A 
            class=nav 
            href="#" onclick="changeIframe('updateOperator.jsp')">修改操作员</A></TD>
        </TR>
        <TR>
          <TD bgColor=#ffffff colSpan=2><IMG height=1 
        ...
        <TR>
          <TD width=11 bgColor=#2650a6><IMG height=1 
            src="images/blank.gif" width=1 border=0><img src="images/Arrow1.gif" width="23" height="23"></TD>
          <TD width=165 height="29" bgColor=#7691c7>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<A 
            class=nav href="#" onclick="changeIframe('resource.jsp')">资源管理</A></TD>
        </TR>
        <TR>
          <TD bgColor=#ffffff colSpan=2><IMG height=1 
            src="images/blank.gif" width=1 border=0></TD></TR>
        <TR>
          ...
          <TD width=165 height="29" bgColor=#7691c7>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<A 
            class=nav 
            href="#" onclick="changeIframe('charge.jsp')">配置业务费用</A></TD>
        </TR>
        <TR>
          <TD bgColor=#ffffff colSpan=2><IMG height=1 
            src="images/blank.gif" width=1 border=0></TD></TR>
        ...
        <TR>
          ...
          <TD width=165 height="29" bgColor=#7691c7>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<A 
            class=nav 
            href="#" onclick="changeIframe('newCustomer.jsp')">开户</A></TD>
        </TR>
  ...
  <TR vAlign=top>
    <TD height="600" bgColor=#f1f3f9>  
       <iframe width="100%" height="100%" src="MyHtml.html" id="iframe"></iframe>
    </TD>
    </TR>
  </TBODY></TABLE>
<BR></CENTER></BODY></HTML>
